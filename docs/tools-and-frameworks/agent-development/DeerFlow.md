...
set "PATH=C:\tools\nginx-1.29.8;%PATH%" # $env:Path = "C:\tools\nginx-1.29.8;$env:Path"
make install  # 安装 backend + frontend 依赖
$env:LANGGRAPH_ALLOW_BLOCKING="1"
make dev
```
http://localhost:2026
...
> **仓库地址**：[github.com/bytedance/deer-flow](https://github.com/bytedance/deer-flow)
> **总结日期**：2026-04-13
...
DeerFlow 使用 Python 开发后端，前端基于 Node.js。推荐使用以下工具快速搭建：

- **uv**：Python 包管理
- **Docker Compose**：一键启动所有服务（后端、前端、沙箱等）
