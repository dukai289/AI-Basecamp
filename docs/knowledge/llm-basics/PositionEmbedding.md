---
title: Position Embedding 位置编码
sidebar_position: 5
tags: [位置编码, Position Embedding, RoPE, ALiBi, Sinusoidal PE, 长上下文]
...
因此，Transformer 需要一个额外机制，把“位置信息”注入到 Attention 或输入表示里，这就是**位置编码**。
