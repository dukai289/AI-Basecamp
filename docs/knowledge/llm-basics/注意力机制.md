...
| 架构类型 | Self / Cross | Mask - 非 Self/ Causal/ Bidirectional | 典型模型 | 主要用途 |
|---|---|---|---|---|
...
| Encoder-Decoder | Self + Cross | Bidirectional Encoder + Causal Decoder | T5 / BART | Seq2Seq 类: 翻译、摘要、生成等 |
...
更完整解释可以看：[位置编码](./PositionEmbedding.md)。
